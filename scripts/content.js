...
axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(document.location).then(data => {
...
function handlePagination(table) {
  ...
  if (nextPageLink) {
    ...
    nextPageLink.click();
    setTimeout(() => {
      getTableAtClickPosition(table.getBoundingClientRect().x, table.getBoundingClientRect().y).then(nextTable => {
        if (nextTable) {
...
async function setPreset() {
  const ssStr = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("https://elekta.axeda.com/drm/actions/home/user-preferences/show");
  ...
  await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("https://elekta.axeda.com/drm/actions/home/user-preferences/modify", {
    Headers: {
...
async function DownloadData() {
  ...
  let response = "";
  try {
    response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(strUr + myPages).data;
  } catch (e) {
  ...
  if (bb1.length > 0) {
    if (bb1[1] - 100000 > 0 && bb1[1] - 160000 < 0) var linacSN = bb1[1];
  }
  let str1 = response;
  ...
  do {
    ...
    const nextResponse = await (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])(strUr + myPages);
